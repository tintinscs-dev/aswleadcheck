...
export const TRANSLATIONS = {
  vi: {
    ...
    'field.lcl': 'CBM',
    'field.weight': 'Khối lượng (G.W - KG)',
    'field.cw': 'C.W (Chargeable Weight - KG)',
    'field.pieces': 'Số kiện (PKGS)',
    'field.notes': 'Ghi chú',
    ...
    'table.col.unit': 'Đơn vị tính',
    'table.col.vat': 'VAT %',
    'table.col.currency': 'Tiền',
    'table.addItem': '+ Thêm hạng mục',
    'table.customNote': 'Hạng mục tự thêm sẽ được cộng gộp vào Local Charges khi xuất Excel/PDF.',
    'tab.internalData': 'Dữ liệu nội bộ',
    ...
    'sum.cktm': 'CKTM',
    'sum.cktmLine': 'CKTM (Giá mua)',
    'sum.cktmClient': 'CKTM (Giá bán)',
    'sum.cktmTotal': 'Tổng CKTM (đã gồm trong GVDV/DTLH)',
  ...
  en: {
    ...
    'field.qty40': "Qty 40'",
    'field.lcl': 'CBM',
    'field.weight': 'Weight (G.W - KG)',
    'field.cw': 'C.W (Chargeable Weight - KG)',
    'field.pieces': 'Pieces (PKGS)',
    'field.notes': 'Notes',
    ...
    'table.col.price': 'Unit Price',
    'table.col.unit': 'Unit',
    'table.col.vat': 'VAT %',
    'table.col.currency': 'Ccy',
    'table.addItem': '+ Add charge',
    'table.customNote': 'Custom charges will be merged into Local Charges on Excel/PDF export.',
    'tab.internalData': 'Internal Data',
    ...
    'sum.dtlh': 'Revenue',
    'sum.cktm': 'CKTM',
    'sum.cktmLine': 'CKTM (Buying)',
    'sum.cktmClient': 'CKTM (Selling)',
    'sum.cktmTotal': 'Total CKTM (already included in COGS/Revenue)',
