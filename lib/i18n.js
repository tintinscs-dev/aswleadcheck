...
export const TRANSLATIONS = {
  vi: {
    ...
    'form.locked': 'Báo giá đã được duyệt — chỉ Admin/Operation/Pricing/Sales (báo giá của mình) có thể điều chỉnh phí.',
    'form.adjusting': 'Báo giá đã duyệt — bạn chỉ đang điều chỉnh các bảng phí (giá mua/bán/công nợ). Mọi thay đổi sẽ được ghi vào lịch sử và áp dụng ngay (quyền Admin).',
    'form.adjustingProposal': 'Báo giá đã duyệt — bạn chỉ đang điều chỉnh các bảng phí (giá mua/bán/công nợ). Thay đổi sẽ được gửi thành đề xuất, chờ Manager duyệt trước khi có hiệu lực.',
    'form.pendingAdjustment': 'Báo giá này đang có một đề xuất điều chỉnh phí chờ Manager duyệt. Vui lòng chờ xử lý xong trước khi điều chỉnh tiếp.',
    ...
    'field.notes': 'Ghi chú',
    'field.extraTerms': 'Lưu ý thêm cho báo giá in ra (tùy chọn)',
    'field.extraTerms.placeholder': 'Vd: Miễn phí lưu kho 3 ngày đầu...',
    'field.extraTerms.add': '+ Thêm ghi chú',
    'field.extraTerms.help': 'Các dòng này sẽ được thêm vào cuối mục "Điều khoản & Lưu ý" khi in báo giá PDF/Excel cho lô hàng này.',

    // ── Section I (Overseas) / II / III ─────────────────────────────────────────
    'sec1.title': 'I. OVERSEAS CHARGES (CHI PHÍ ĐẦU NƯỚC NGOÀI)',
    'table.overseasNote': 'Chi phí phát sinh ở đầu nước ngoài cho lô hàng xuất/nhập (VD: Destination/Origin THC, phí khai hải quan nước ngoài, trucking đầu nước ngoài...). Tự thêm dòng theo từng lô — sẽ hiện thành mục riêng khi xuất báo giá.',
    ...
    'table.col.note': 'Ghi chú (hiện trên báo giá)',
    ...
    'adjust.proposedAlert': 'Đã gửi đề xuất điều chỉnh phí. Thay đổi sẽ có hiệu lực sau khi Manager duyệt.',
    ...
    'btn.proposeAdjust': '📤 Gửi đề xuất điều chỉnh (chờ Manager duyệt)',
  ...
  en: {
    ...
    'form.locked': 'This quote is approved — only Admin/Operation/Pricing/Sales (own quote) can adjust fees.',
    'form.adjusting': 'Approved quote — you are only adjusting fee tables. Changes are logged to history and applied immediately (Admin privilege).',
    'form.adjustingProposal': 'Approved quote — you are only adjusting fee tables. Your change will be submitted as a proposal, pending Manager approval before it takes effect.',
    'form.pendingAdjustment': 'This quote already has a fee-adjustment proposal awaiting Manager approval. Please wait until it is resolved before adjusting again.',
    ...
    'field.notes': 'Notes',
    'field.extraTerms': 'Extra notes for printed quotation (optional)',
    'field.extraTerms.placeholder': 'E.g.: First 3 days free storage...',
    'field.extraTerms.add': '+ Add note',
    'field.extraTerms.help': 'These lines are appended to the end of "Terms & Notes" when printing the PDF/Excel quotation for this shipment.',

    // ── Section I (Overseas) / II / III ─────────────────────────────────────────
    'sec1.title': 'I. OVERSEAS CHARGES',
    'table.overseasNote': 'Charges incurred at the overseas end for export/import shipments (e.g. Destination/Origin THC, overseas customs clearance, overseas trucking...). Add rows as needed per shipment — shown as its own section on the quotation.',
    ...
    'table.col.note': 'Note (shown on quotation)',
    ...
    'adjust.proposedAlert': 'Adjustment proposal submitted. It will take effect once a Manager approves it.',
    ...
    'btn.proposeAdjust': '📤 Submit Adjustment Proposal (pending Manager approval)',
