...
function drawCostTable(doc, x, y, title, side, mode, q, maxWidth) {
  const colWidths = [maxWidth * 0.30, maxWidth * 0.17, maxWidth * 0.13, maxWidth * 0.1, maxWidth * 0.1, maxWidth * 0.2];
  const headers = ['Hạng mục', 'Đơn giá', 'Đơn vị tính', 'VAT%', 'Tiền', 'Thành tiền'];
