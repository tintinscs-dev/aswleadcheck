...
import { MODE_LABELS, MODE_UNIT, ITEM_DEFS, lineTotal, qtyForMode, quoteModes, itemCurrency } from './calc';
...
export function quoteToFormalTemplate(quote, opts = {}) {
  ...
  t.valid = opts.validDays ? `${opts.validDays} ngày kể từ ngày phát hành` : '30 ngày kể từ ngày phát hành';
  t.pol = q.pol || '';
  t.pod = q.pod || '';
