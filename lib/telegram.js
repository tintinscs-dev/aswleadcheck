...
const ACTION_LABEL = {
  ...
  adjustment_proposed: 'Đề xuất điều chỉnh phí — chờ Manager duyệt',
  adjustment_approved: 'Manager đã duyệt điều chỉnh phí',
  adjustment_rejected: 'Manager từ chối điều chỉnh phí',
};
